...
export default function Navbar() {
  ...
  return (
    <nav className='text-white flex justify-center gap-3 text-xl'>
      <div className='w-5 h-4 flex flex-col justify-between my-3 lg:hidden' onClick={toggleDropdown}>
        <div className='h-[2px] bg-white w-full'></div>
        <div className='h-[2px] bg-white w-full'></div>
        <div className='h-[2px] bg-white w-full'></div>
      </div>
      {isOpen && (
        <div className='h-screen w-screen absolute top-0 left-0 -z-10 bg-gradient-to-br from-black to-violet-950'>
